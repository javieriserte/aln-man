package org.jiserte.alnman.commands.misc;
 ...
 *
 */
public class CalculateMICommand extends FastaCommand<NoArgumentOption> {

	public CalculateMICommand(InputStream inputstream, PrintStream output, 	NoArgumentOption option) {
