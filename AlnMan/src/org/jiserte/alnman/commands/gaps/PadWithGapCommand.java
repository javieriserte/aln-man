 ...
 *
 */
public class PadWithGapCommand extends FastaCommand<NoArgumentOption> {

	public PadWithGapCommand(InputStream inputstream, PrintStream output, NoArgumentOption option) {
