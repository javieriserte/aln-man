package org.jiserte.alnman.commands.identity;
...
import org.jiserte.bioseq.identity.IndentityMatrixCalculator;
 ...
 *
 */
public class MDSCommand extends FastaCommand<SingleArgumentOption<Integer>> {
	
	int  dimensions;

	public MDSCommand(InputStream inputstream, PrintStream output, SingleArgumentOption<Integer> option) {
		
		super(inputstream, output, option);
		
		this.dimensions = this.getOption().getValue();
